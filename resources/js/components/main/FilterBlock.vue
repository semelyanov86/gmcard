    ...
    <div class="filter_block z-31 mb-6 flex h-12 items-center justify-between lg:h-full">
        ...
        <div class="gapper filter_inp relative flex h-full items-center gap-6">
            ...
            <div class="selected_block relative inline-block h-12">
                <div
                    class="custom-select focus:shadow-outline flex h-12 w-52 appearance-none items-center rounded-md border border-white bg-none px-4 py-2 pr-8 leading-tight text-white shadow hover:border-gray-300 focus:outline-none"
                >
