...
<template>
    <div class="flex bg-white p-8 max-md:p-4 mt-8 rounded-2xl flex-col w-full">
        ...
        <div class="my-6">
            ...
            <div class="flex flex-row max-md:flex-col justify-between items-center max-md:items-start my-4">
                <p class="mr-10 max-md:mr-0 max-md:mb-4 text-black/50 all_text">
                    <strong class="text-black text-base">Допополнительные условия.</strong>
                    ...
                    <span @click="emit('openConditionsModal')" class="text-[#2578cf] ml-3 hover:underline cursor-pointer">Подробнее</span>
                </p>
