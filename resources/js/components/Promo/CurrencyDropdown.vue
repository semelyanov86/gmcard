...
<template>
    <div class="relative inline-block">
        <button
            ...
            type="button"
            class="focus:ring-blue flex h-10 w-28 items-center justify-between rounded-md border border-gray-300 bg-white px-4 text-sm leading-5 font-medium text-gray-700 shadow-sm transition duration-150 ease-in-out hover:text-gray-500 focus:border-blue-300 focus:outline-none active:bg-gray-100 active:text-gray-700"
        >
            <span>{{ modelValue }}</span>
            <ChevronDownIcon custom-class="w-4 h-4 ml-2 -mr-1 text-blue-600" />
        </button>
