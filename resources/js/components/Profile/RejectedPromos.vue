...
<template>
    <div class="w-3/4 p-10 rounded-2xl" style="background-color:#063965" id="rejectPromo">
        <h2 class="text-4xl text-white mb-5">Мои отклоненные акции</h2>
