...
<template>
    <div class="w-3/4 p-10 rounded-2xl" style="background-color:#063965" id="endPromo">
        <h2 class="text-4xl text-white mb-5">Мои завершенные акции</h2>
        <div class="flex flex-wrap justify-between gap-4">
            <div class="bg-none border border-white/10 px-5 pb-5 min-w-[300px] rounded-xl flex gap-5">
                    ...
                    <div class="rounded-xl lg:w-[232px] w-[262px] mt-7 relative main_card">
                        ...
                        <div class="absolute -top-6 left-4 z-40" data-tooltip-target="tooltip-default" type="button">
                            ...
                            <div
                                id="tooltip-default"
                                role="tooltip"
                                class="absolute z-10 w-[250px] invisible inline-block px-3 py-2 text-sm font-medium text-white transition-opacity duration-300 bg-[#041f35] rounded-lg shadow-sm opacity-0 tooltip"
                            >
                ...
                <div class="mt-7 flex flex-col items-center gap-4">
                    <button data-tooltip-target="tooltip-delete-completed" data-tooltip-placement="top" class="hovBg relative">
                        <svg
                            xmlns="http://www.w3.org/2000/svg"
                            fill="none"
                            viewBox="0 0 24 24"
                    ...
                    <button data-tooltip-target="tooltip-write-completed" data-tooltip-placement="top" class="hovBg relative">
                        <svg
                            xmlns="http://www.w3.org/2000/svg"
                            fill="none"
                            viewBox="0 0 24 24"
