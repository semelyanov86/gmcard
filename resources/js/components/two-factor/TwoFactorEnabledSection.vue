...
<template>
    <div class="space-y-6">
        ...
        <div class="space-y-4">
            <div class="flex items-center justify-between">
                ...
                <Button 
                    variant="outline" 
                    size="sm" 
                    @click="emit('show-recovery-codes')" 
            ...
            <p class="text-sm text-muted-foreground">
                Сохраните эти коды восстановления в надёжном месте. Они могут быть использованы для восстановления доступа 
                к вашему аккаунту, если вы потеряете устройство с двухфакторной аутентификацией.
            </p>
            ...
            <div v-if="showRecoveryCodes && recoveryCodes.length > 0" class="space-y-4">
                ...
                <Button variant="outline" @click="emit('regenerate-recovery-codes')">
                    Создать новые коды
                </Button>
            </div>
        </div>
        ...
        <div class="space-y-4 pt-6 border-t">
            ...
            <p class="text-sm text-muted-foreground">
                Если вы хотите отключить двухфакторную аутентификацию, нажмите кнопку ниже.
            </p>
