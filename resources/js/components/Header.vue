        ...
        <div class="relative mx-auto flex w-[1140px] items-center justify-between 2xl:w-full 2xl:px-4">
            ...
            <div class="auth_block relative ml-3 hidden items-center">
                <svg
                    ...
                    stroke="currentColor"
                    class="h-5 w-5 rounded-lg text-gray-500 focus:ring-2 focus:ring-gray-200 focus:outline-none dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600"
                >
                    <path
                ...
                <svg
                    ...
                    class="absolute right-12 -bottom-4 h-4 w-4 text-white"
                    viewBox="0 0 24 11"
                    xmlns="http://www.w3.org/2000/svg"
                >
                    <path d="M24 11H0L12 0L24 11Z" fill="currentColor"></path>
                </svg>
                <button
                    id="open_menu"
            ...
            <ul id="header" class="relative flex list-none items-center md:hidden">
                <li class="relative rounded-md bg-[#f4d710] px-3 py-2 hover:opacity-100 focus:ring-2 focus:ring-[#f4d710]">
                    ...
                    <svg
                        ...
                        fill="currentColor"
                        id="startBTN"
                        class="absolute right-14 -bottom-8 h-7 w-6 text-white"
                        viewBox="0 0 24 11"
                        xmlns="http://www.w3.org/2000/svg"
                    >
                ...
                <li class="relative">
                    ...
                    <svg
                        ...
                        fill="currentColor"
                        id="loginBTN"
                        class="absolute right-0 -bottom-10 h-7 w-6 text-white"
                        viewBox="0 0 24 11"
                        xmlns="http://www.w3.org/2000/svg"
                    >
                        <path d="M24 11H0L12 0L24 11Z" fill="currentColor" />
            ...
            >
                <div class="relative p-5">
                    <svg
                        ...
                        stroke-width="1.5"
                        stroke="currentColor"
                        class="absolute top-6 right-6 h-8 w-8 cursor-pointer text-gray-400 opacity-50 hover:opacity-100"
                    >
                    ...
                    <div class="my-3">
                        ...
                        <div class="mt-2 flex items-center gap-2">
                            <a href="#">
                                <svg
                                    fill="#fff"
                                    class="h-6 w-6 opacity-10 hover:opacity-100"
                                    version="1.1"
                                    id="Layer_1"
                                    xmlns="http://www.w3.org/2000/svg"
                            ...
                            <a href="#">
                                ...
                                >
                                    <g>
                                        <path
                                            d="M89,0H5C2.238,0,0,2.239,0,5v84c0,2.761,2.238,5,5,5h84c2.762,0,5-2.239,5-5V5C94,2.239,91.762,0,89,0z M74.869,52.943
                            ...
                            <a href="#">
                                <svg
                                    fill="#fff"
                                    class="h-8 w-8 opacity-10 hover:opacity-100"
