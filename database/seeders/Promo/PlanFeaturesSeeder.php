        ...
        foreach ($features as $featureData) {
            $feature = PlanFeature::query()->firstOrCreate(
                ...
                [
                    ...
                    'category' => $featureData['category'] ?? 'detailed',
                ],
            );

            if ($feature->category !== ($featureData['category'] ?? 'detailed')) {
                $feature->update(['category' => $featureData['category'] ?? 'detailed']);
            }
