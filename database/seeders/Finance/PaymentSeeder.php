...
class PaymentSeeder extends Seeder
{
    ...
    {
        $items = [
            ['payment_date' => '2025-01-02 10:00:00', 'amount' => 500, 'type' => 'Списание', 'description' => 'Оплата заказа #1001', 'transaction_id' => 1, 'user_id' => 1],
            ...
            ['payment_date' => '2025-02-10 13:35:00', 'amount' => 450, 'type' => 'Поступление', 'description' => 'Кэшбэк за заказы', 'transaction_id' => 9, 'user_id' => 9],
            ['payment_date' => '2025-02-14 19:25:00', 'amount' => 1500, 'type' => 'Списание', 'description' => 'Оплата заказа #1005', 'transaction_id' => 10, 'user_id' => 10],
        ];
